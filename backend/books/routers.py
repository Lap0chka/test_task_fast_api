...
@book_router.post(
    "/", response_model=BookOutSchema, status_code=status.HTTP_201_CREATED
)
async def create_book(
    ...
    book = await service.create_book(book_schema=book_schema)
...
async def create_book(
    ...
    author = await service.create_author(author_schema=author_schema)
